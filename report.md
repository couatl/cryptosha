...
Графический пользовательский интерфейс(далее - GUI) проекта сделан в среде разработки Qt. Этот выбор был сделан по причине удобства и широкого функционала данной среды.

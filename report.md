...
Для запуска структурированной отрисовки нужно нажать на кнопку `Draw with AI`, для неструктурированной - `Draw`, после чего происходит отрисовка схемы в окне отрисовки.

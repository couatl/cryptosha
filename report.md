...
2. Существует ряд библиотек `boost`, использование которых сильно уменьшило объем кода и позволило сократить время на написание аналогичных классов.  
...
Графическая составляющая проекта сделана в среде разработки Qt. Этот выбор был сделан по причине удобства и широкого функционала данной среды.
